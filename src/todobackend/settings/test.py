...
# we are using environment varaibles by using os.environ.get command
# if the environment variables settings are not found then default setting are applied
